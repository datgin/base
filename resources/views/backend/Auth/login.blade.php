                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4 ">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">
                                        Đăng nhập để tiếp tục đến trang quản trị.</p>
                                </div>
                                <div class="alert alert-danger d-none" id="alert" role="alert">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1 ms-3" id="error">

                                        </div>
                                    </div>
                                </div>
                                <div class="p-2 mt-4">
                                    <form action="" method="post" id="auth-login-form">
        ...
        $('#auth-login-form').submit(function(e) {
            ...
            $.ajax({
                ...
                error: function(error) {
                    $('input').removeClass('is-invalid').siblings('small').removeClass('text-danger')
                        .text('');
                    ...
                    if (error.responseJSON.code == 401) {
                        ...
                        $('#error').text(error.responseJSON.messages);
                    } else {
