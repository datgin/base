...
if (! function_exists('errorResponse')) {
    function errorResponse(string $message, int $code = 500, bool $isResponse = false)
    {
...
if (! function_exists('successResponse')) {
    function successResponse(string $message, array $data = [], int $code = 200, bool $isResponse = false)
    {
